...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       print("  <form method=\"post\" action=\"./existing_issues_all.php\" id=\"thisfrm\">
                 ...
                 <table border='0' scroll=\"yes\">
                  <caption>$captn</caption>
                   <tr>
                     ...
                     <td bgcolor=\"#CCCCCC\" align=\"center\" valign=\"middle\" colspan=\"4\"><font color=\"#330099\" style=\"width: 250px;\">Created</font></td>
                     <td bgcolor=\"#CCCCCC\" align=\"center\" valign=\"middle\" colspan=\"4\"><font color=\"#330099\" style=\"width: 450px;\">Last Update</font></td>
                     <td bgcolor=\"#ECE5B6\" align=\"center\" valign=\"middle\" rowspan=\"2\"><font color=\"#330099\">Updates</font></td>
                   ...
                   <tr>
                     ...
                     <td bgcolor=\"#99CCFF\" align=\"center\" valign=\"middle\"><font color=\"#330099\" style=\"width: 100px;\">On</font></td>
      ...
      if ($rowcnt <> 0){           
          $seq = 0;
           while($row = mysql_fetch_row($mysql_data)) {
                 ...
                 $queryh2 = "select a.issue_history_id,a.issue_id,a.issue_assignee,a.issue_note_dt,a.issue_note,
                             ...
                             where a.issue_id = '$xid2' 
                               and a.issue_area_id_by = b.issue_area_id 
                               and a.issue_area_id    = c.issue_area_id 
                          order by a.issue_history_id desc"; //limit 1
                 //print($queryh);
                 $mysql_datah2 = mysql_query($queryh2, $mysql_link) or die ("#101 Could not query: ".mysql_error());
                 ...
                 if ($rowcnth == 1) {
                    while($rowh = mysql_fetch_row($mysql_datah)) {
                           ...
                           $xissue_area_c     = stripslashes($rowh[7]); 
                    }
                 } else {
                 ...
                 print("
                        <tr>
                         <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\">
                          <font color=\"$fcolr\">
	                       <a href=\"#\" onclick=\"parent.document.all['content2'].innerHTML='&lt;iframe src=&quot;issue_updates_all.php?v_issue_id=$xid2&&v_issue_hist_id=$xid3&&v_usr=$usr&&pdp=$pdp&&uissue_area=$uissue_area&quot; width=&quot;100%&quot; height=&quot;100%&quot; scrolling=&quot;auto&quot; frameborder=&quot;no&quot;&gt;&lt;/iframe&gt;'\">
                            $xid2
                           </a>
                          </font>
                ...
                print("         
                         ...
                         <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\">
                          <font color=\"$fcolr\"  style=\"width: 100px;\">
                           $xcreate_dt
                          </font>
                         </td>
                         <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\">
           ...
           print("<script type=\"text/javascript\">
                    document.forms['thisfrm'].action=\"./existing_issues_all.php\";
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./existing_issues_all.php\">
           <table border='0' scroll=\"yes\">
            <tr>
