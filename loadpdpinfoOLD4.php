...
while($rowl = mysql_fetch_row($mysql_datal)) {
	  ...
	  // Cable
	  if ($productline == "CABLE" || $productline == "HP" || $productline == "INTFIX" || $productline == "VIDEO" || $productline == "CABLE TV" || $productline == "RCG" || $productline == "RHSI"){
	      $lob   = 2;
	  }
	  // Wireless
	  if ($productline == "FIDO" || $productline == "INTMOB" || $productline == "WDATA" || $productline == "WDUAL" || $productline == "WI" || $productline == "WVOICE"){
	      $lob   = 3;
	  }
