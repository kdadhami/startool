...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       print("  <form method=\"post\" action=\"./enter_issue_existing_2.php\" id=\"thisfrm\">
       ...
       print("      </font>
                 ...
                 <table border='0' scroll=\"yes\">
                  <caption>$captn</caption>
                   <tr>
                    <td bgcolor=\"#FFFFFF\" align=\"center\" valign=\"middle\" colspan=\"11\"><font color=\"#0000FF\"><strong>ISSUES RAISED FOR $uissue_area</strong></font></td>
                   </tr>
                   <tr>
                     <td bgcolor=\"#FF0000\" align=\"center\" valign=\"middle\" rowspan=\"2\"><font color=\"#FFFFFF\">Issue No.</font></td>
                     <td bgcolor=\"#CCCCCC\" align=\"center\" valign=\"middle\" colspan=\"4\"><font color=\"#330099\" style=\"width: 325px;\">Created</font></td>
                     <td bgcolor=\"#CCCCCC\" align=\"center\" valign=\"middle\" colspan=\"5\"><font color=\"#330099\" style=\"width: 375px;\">Last Update</font></td>
                     <td bgcolor=\"#ECE5B6\" align=\"center\" valign=\"middle\" rowspan=\"2\"><font color=\"#330099\">Update</font></td>
                   </tr>
                   <tr>
                     <td bgcolor=\"#99CCFF\" align=\"center\" valign=\"middle\"><font color=\"#330099\" style=\"width: 175px;\">Title</font></td>
          ...
          $seq = 0;
           while($row = mysql_fetch_row($mysql_data)) {
                 ...
                 print("
                        <tr>
                         <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\">
                          <font color=\"#330099\">
	                       <a href=\"#\" onclick=\"parent.document.all['content2'].innerHTML='&lt;iframe src=&quot;enter_issue_updates_3.php?v_issue_id=$xid2&&v_issue_hist_id=$xid3&&v_usr=$usr&&pdp=$pdp&&uissue_area=$uissue_area&quot; width=&quot;100%&quot; height=&quot;100%&quot; scrolling=&quot;auto&quot; frameborder=&quot;no&quot;&gt;&lt;/iframe&gt;'\">
                            $xid2
                           </a>
                          </font>
                ...
                if ($xissue_area_by == $uissue_area){         
                    print(" <td align=\"left\" valign=\"middle\" style=\"width: 175px; word-wrap: break-word; word-break:break-all; background-color: $bcolr\">
                             <font color=\"#330099\">
                             <textarea name=\"xissue_desc[$xid2]\" rows=\"2\" style=\"width: 175px; word-wrap: break-word; word-break:break-all;\">$xissue_desc</textarea>
                            </td>
                    ");        
                } else {
                    print(" <td align=\"left\" valign=\"middle\" style=\"width: 175px; word-wrap: break-word; word-break:break-all; background-color: $bcolr\">
                             <font color=\"#330099\">
                              <p style=\"width: 175px; word-wrap: break-word; word-break:break-all;\">
                               $xissue_desc
                              </p>
                ...
                print("         
                         <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\">
                          <font color=\"#330099\"  style=\"width: 50px;\">
                           $xcreated_by
                          </font>
                         </td>
                         <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\">
                         ...
                         <td align=\"left\" valign=\"middle\" style=\"width: 175px; word-wrap: break-word; word-break:break-all; background-color: $bcolr\">
                          <font color=\"#330099\">
                           <p style=\"width: 175px; word-wrap: break-word; word-break:break-all;\">
                            $xissue_note
                           </p>    
                         </td>
                         <td bgcolor=\"$lcolr\" align=\"center\" valign=\"middle\">
                          <font color=\"#330099\"  style=\"width: 50px;\">
                           $xissue_assignee
                          </font>
                         </td>
           ...
           print("
                   ...
                   <tr>
                    <td bgcolor=\"#FFFFFF\" align=\"center\" valign=\"middle\" colspan=\"11\"><font color=\"#0000FF\"><strong>ISSUES RAISED BY $uissue_area FOR OTHERS</strong></font></td>
                   </tr>
                   <tr>
                     <td bgcolor=\"#FF0000\" align=\"center\" valign=\"middle\" rowspan=\"2\"><font color=\"#FFFFFF\">Issue No.</font></td>
                     <td bgcolor=\"#CCCCCC\" align=\"center\" valign=\"middle\" colspan=\"4\"><font color=\"#330099\" style=\"width: 325px;\">Created</font></td>
           ...
           while($row2 = mysql_fetch_row($mysql_data2)) {
                 ...
                 ");
                 if ($xissue_area_by_id == $uissue_area_id){
                     print("
                              <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\">
                               <font color=\"#330099\">
                                <input type=\"checkbox\" name=\"update[$xid2]\" value=\"Update\">
           ...
           print("
                   ...
                   <tr>
                    <td bgcolor=\"#FFFFFF\" align=\"center\" valign=\"middle\" colspan=\"11\"><font color=\"#0000FF\"><strong>OTHER ISSUES NOW WITH $uissue_area</strong></font></td>
                   </tr>
                   <tr>
                     <td bgcolor=\"#FF0000\" align=\"center\" valign=\"middle\" rowspan=\"2\"><font color=\"#FFFFFF\">Issue No.</font></td>
                     <td bgcolor=\"#CCCCCC\" align=\"center\" valign=\"middle\" colspan=\"4\"><font color=\"#330099\" style=\"width: 325px;\">Created</font></td>
                     <td bgcolor=\"#CCCCCC\" align=\"center\" valign=\"middle\" colspan=\"5\"><font color=\"#330099\" style=\"width: 375px;\">Last Update</font></td>
                     <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\" rowspan=\"2\"><font color=\"#330099\">&nbsp</font></td>
                   </tr>
                   <tr>
                     <td bgcolor=\"#99CCFF\" align=\"center\" valign=\"middle\"><font color=\"#330099\" style=\"width: 175px;\">Title</font></td>
                     <td bgcolor=\"#99CCFF\" align=\"center\" valign=\"middle\"><font color=\"#330099\" style=\"width: 50px;\">By</font></td>
           ...
           print("<script type=\"text/javascript\">
                    document.forms['thisfrm'].action=\"./enter_issue_existing_2.php\";
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./enter_issue_existing_2.php\">
           <table border='0' scroll=\"yes\">
            <tr>
