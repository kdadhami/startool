...
$xreport_pth = "./reports/";
$xreport_nam = "ISSUE SUMMARY REPORT (GROUPED)-".$ydate3.".htm";
//print ($reportname); 
//Start of HTML
//================================================================================================================
...
if ($start == 1) {
   ...
   if ($rowcntx > 0) {
       ...
       while($rowttl = mysql_fetch_row($mysql_datax)) {
             ...
             if ($seq == 1) {
                 ...
                 $captn = "ISSUE SUMMARY REPORT (GROUPED)";
   ...
   $xreport_name = "ISSUE SUMMARY REPORT (GROUPED)"; 
...
if ($found == 0) {
   ...
   $query = "  select saved_report_id,report_name,filters,report_path,etl_id,report_timestamp,ran_by from ".$name.".saved_reports
                where rtrim(report_name) = 'ISSUE SUMMARY REPORT (GROUPED)'
                  and ran_by = '$usr'
