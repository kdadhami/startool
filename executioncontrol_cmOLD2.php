                         ...
                         if ($yactual_start_date == 0){
                            ...
                            while($rowx29 = mysql_fetch_row($mysql_data29)) {
                                  ...
                                  //print($yback_to_build_sum."<br>");
                                    ...
                                    if ($d4 == 6){
                                        $testingdays          =  round((($yend_dt - $ystart_dt) / 86400),0);
                                        $daysindelay          =  0;
                                        $incval = 86400;
                                        $wkday1 = 0;
                                        $wkend1 = 0;
                                    ...
                                    if ($d4 == 7){
                                        $testingdays          =  round((($yend_dt - $ystart_dt) / 86400),0);
                                        $daysindelay          =  round(((($yactual_end_date - $ystart_dt) / 86400) - $testingdays),0);
                                        $incval = 86400;
                                        $wkday1 = 0;
                                        $wkend1 = 0;
                                        $basedt1 = $ystart_dt;
                                    ...
                                    //        $wkdayx = $yactual_testing_days;
                                    //        $wkendx = 0;
                                    //        $wkdayu = round(($yactual_testing_days / $wkday3),2)*100;
                                    //        $wkendu = 0;
                                    //    } else {
                                    //        $wkdayx = $yactual_testing_days;
                                    //        $wkendx = $yactual_testing_days - $wkday3;
                                    //        $wkdayu = round(($wkday3 / $wkday3),2)*100;
                                    //        $wkendu = round((($yactual_testing_days - $wkday3) / $wkend3),2)*100;
                                    //    }
                                    //    $utilp = $wkdayx." (Weekdays ".$wkdayu."%)<br>".$wkendx." (Weekends ".$wkendu."%)"; 
                                    //} else {
                                    //     $wkdayu      = 0;
                                    //     $wkendu      = 0;
                                    //     $utilp       = "TBD";
                                    ...
                                    if (($yactual_testing_days <> 0) && ($totdays <> 0)) {
                                        ...
                                        if ($yactual_weekend_days == 0){
                                            ...
                                            $wkendx = $yactual_weekend_days;
                                            $wkendu = round(($yactual_weekend_days / $wkend3),2)*100;
                                        }
                                        //if ($yactual_testing_days <= $wkday3){
                                        //    $wkdayx = $yactual_testing_days;
                                        //    $wkendx = 0;
