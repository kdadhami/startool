			...
			while (list($key3x) = each($update3)) {
                         ...
                         while($row44c = mysql_fetch_row($mysql_data44c)) {
							   ...
							   if ($occrnc >=1){
                                   ...
                                   while($row44e = mysql_fetch_row($mysql_data44e)) {
										 ...
										 $yretrofit_parity_2[$key2x][$key3x]  = stripslashes($row44e[4]);
				               ...
				               $ymilestone_type[$key2x][$key3x]              = stripslashes($row44d[5]);
				               $ymilestone_time[$key2x][$key3x]              = stripslashes($row44d[6]);
							   //$ymilestone_time[$key2x][$key3x]            = $ymilestone_time[$key2x][$key3x];
				         }
				     }
					 if ($tblsrc == "A"){
                   ...
                   if ($yajustment[$key2x][$key3x] == "NULL"){				   
			          if (($ymilestone_type[$key2x][$key3x] == "F") or ($ymilstone_type[$key2x][$key3x] == "N")){
				          // Iteration Count
                          if (empty($yiteration_cnt[$key2x][$key3x])){                         // or ($yajustment[$key2x][$key3x] == "NULL" and $yiteration_cnt[$key2x][$key3x] == 0)
                              $yiteration_cnt[$key2x][$key3x]           = 0;
                              $ziteration_cnt                           = addslashes($yiteration_cnt[$key2x][$key3x]);
                              //$ybaseline_time[$key2x][$key3x]           = addslashes($prv_baseline_time[$key2x][$key3x]);
				      	      $yincremental_time[$key2x][$key3x]        = 0;
				              $ytotal_time[$key2x][$key3x]              = $ybaseline_time[$key2x][$key3x] + $yincremental_time[$key2x][$key3x];
                          } else {
                              $ziteration_cnt                           = addslashes($yiteration_cnt[$key2x][$key3x]);
							  //$ybaseline_time[$key2x][$key3x]           = addslashes($prv_baseline_time[$key2x][$key3x]);
							  $yincremental_time[$key2x][$key3x]        = $ziteration_cnt * $ymilestone_time[$key2x][$key3x];
							  $ytotal_time[$key2x][$key3x]              = $ybaseline_time[$key2x][$key3x] + $prv_total_time[$key2x][$key3x];
				      	      // To not allow the yincremental to go below 0
				      	      //if (($ziteration_cnt - $ytotal_iteration_cnt[$key2x][$key3x]) < 0){
				      	      //     $ziteration_cnt = $ytotal_iteration_cnt[$key2x][$key3x]*(-1) ;
				      		  //}
 				              //$ybaseline_time[$key2x][$key3x]           = addslashes($prv_baseline_time[$key2x][$key3x]);
				      	   	  //if ($yajustment[$key2x][$key3x] == "NULL"){
				      		  //$yincremental_time[$key2x][$key3x]        = $ziteration_cnt * $ymilestone_time[$key2x][$key3x];
					      	  //} else {
					      	  //     // Do not change $yincremental_time[$key2x][$key3x] as "Section Adjustment" will set it --- Reference Line (Delta of Incremental Value)
					      	  //}
				   		      //$ytotal_time[$key2x][$key3x]              = $ybaseline_time[$key2x][$key3x] + $prv_total_time[$key2x][$key3x];
                          }
						  $ybaseline_time[$key2x][$key3x]               = addslashes($prv_baseline_time[$key2x][$key3x]);
			          ...
			          if ($ymilestone_type[$key2x][$key3x] == "V"){
				          //if ($yajustment[$key2x][$key3x] == "NULL"){
				              $yincremental_time[$key2x][$key3x]        = ($ymilestone_hrs[$key2x][$key3x]*60) + $ymilestone_min[$key2x][$key3x];
				              if ($yincremental_time[$key2x][$key3x]   == 0){
                                  $ziteration_cnt                       = 0; 
				   	   	      } else {
						          $ziteration_cnt                       = 1;                                           //$ziteration_cnt + 1;
						      }
						      $ybaseline_time[$key2x][$key3x]           = addslashes($prv_baseline_time[$key2x][$key3x]);
						      $yincremental_time[$key2x][$key3x]        = ($ymilestone_hrs[$key2x][$key3x]*60) + $ymilestone_min[$key2x][$key3x];
					      //} else {
                   ...
                   //print("Adjustment: ".$updadj[$key2x][$key3x]."<br>");				   
				   $niteration_cnt                    = $ziteration_cnt;
				   $netiteration                      = $ytotal_iteration_cnt[$key2x][$key3x] + $ziteration_cnt;
				   $noccurance                        = $prv_occurance[$key2x][$key3x] + 1;                                                              //$yoccurance[$key2][$key3];
				   ...
				   $ybaseline_time[$key2x][$key3x]    = ($yb_milestone_hrs[$key2x][$key3x]*60) + $yb_milestone_min[$key2x][$key3x];
                   // Baseline
				   ...
				   $netbaseline                = $prv_baseline_time[$key2x][$key3x];  // $ybaseline_time[$key2x][$key3x]; 
				   ...
				   //print("After - ".$ybaseline_time[$key2x][$key3x]." - ".$yincremental_time[$key2x][$key3x]."<br>");
				   $last_baseline_time                = $prv_baseline_time[$key2x][$key3x];                                                      //(float)$ybaseline_time[$key2x][$key3x]; 
				   $last_incremental_time             = $prv_incremental_time[$key2x][$key3x];                                                   //(float)$yincremental_time[$key2x][$key3x];
				   $last_total_time                   = $prv_baseline_time[$key2x][$key3x] + (float)$prv_incremental_time[$key2x][$key3x];       //(float)$ytotal_time[$key2x][$key3x];
				   ...
				   //print("niteration_cnt: ".$niteration_cnt. " - prv_iteration_cnt: ".$prv_iteration_cnt[$key2x][$key3x]."<br>");
				   //if ($ymilestone_type[$key2x][$key3x] == "F" ){
				   //      if ($yajustment[$key2x][$key3x] == "NULL"){
				   //	       if ($ziteration_cnt == 0){
				   //		       $updchk = 0;
				   //		   } else {
...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       while($rowx = mysql_fetch_row($mysql_datax)) {
             ...
             // start of HTML
             print("
                   <form method=\"post\" action=\"./executioncontrol_uat.php?pdp=$pdp&&start=$start\">
       ...
       while($row42 = mysql_fetch_row($mysql_data42)) {
               ...
               print("  
                         <tr>
                          ...
                          <td align=\"left\" colspan=\"3\" valign=\"middle\" bgcolor=\"#E8E8E8\" style=\"width:30%;\">
                           <font color=\"#330099\"> 
                            $yexecution_id
                           </font> 
                          </td>
               ...
               if ($rowcnt95 <> 0){
                   ...
                   while($rowx95 = mysql_fetch_row($mysql_data95)) {
                         ...
                         //print("  
                         //  <td bgcolor=\"#99CCFF\" align=\"left\" style=\"width:15%;\"><font color=\"#330099\">Area Execution ID</font></td>
                         //  <td align=\"left\" valign=\"middle\" bgcolor=\"#E8E8E8\" style=\"width:30%;\">
                         //   <font color=\"#330099\"> 
                         //    $exid
                         //   </font> 
                         //  </td>
       ...
       if ($rowcnt44 == 0) {
           ...
           print("  
                ...
                <tr>
                 ...
                 <td bgcolor=\"#CCCC99\" align=\"center\" colspan=\"1\" ><font color=\"#330099\">Adjust Rework<br>Effort</font></td>
                ...
                <tr>
                 ...
                 <td bgcolor=\"#CCCCCC\" align=\"center\"><font color=\"#330099\">PDP<br>Total<br>Effort</font></td>
				 <td bgcolor=\"#CCCCCC\" align=\"center\"><font color=\"#330099\">Iterations<br>To Date</font></td>
				 <td bgcolor=\"#FFCC66\" align=\"center\"><font color=\"#330099\">Select<br>Previous Rework Entry<br>to decrement<br><br>Iterations|Time</font></td>
           ...
           while($row44 = mysql_fetch_row($mysql_data44)) {
	            ...
	            $ymilstone_hrs                 = intval($ymilestone_time/60);      
                ...
                while($row44_a = mysql_fetch_row($mysql_data44_a)) {
				      ...
				      if ($yretrofit_parity_a2[$eseq_a] == "N"){
				          $new_parity_cnt   = $new_parity_cnt + 1; 
				      }
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./executioncontrol_uat.php\">
