    ...
    while (list($key2) = each($update2)) {
        ...
        if ($stlc == 1){
         while (list($key3) = each($yiteration_cnt[$key2])) {
                   ...
                   $niteration_cnt = (int)$ziteration_cnt;
               ...
               if ($rowcnt9 == 0){
                         ...
                         for ($yit=1;$yit<=$ytest_iteration; ++$yit) { 
                              //if ($yit == 2){
                                  ...
                                  $yactual_end_date = 0; 
                              //}
                              $query10 = "INSERT into ".$name.".area_execution(pdp_id,issue_area_id,start_date,end_date,test_iteration)
                                          VALUES('$xid','$uissue_area_id','$ystart_dt_x','$yend_dt_x','$yit')";
                              //print($query10);                   
                                  ...
                                  //print($yback_to_build_sum."<br>");
                                    ...
                                    //if ($d4 == 6){
                                        ...
                                        if (($yend_dt > $ystart_dt) && (($ystart_dt <> 0) && ($yend_dt <> 0))){
                                            $testingdays_p       =  round((($yend_dt - $ystart_dt) / 86400),0);
                                            $basedt1             = $ystart_dt;
                                        ...
                                        if ($yactual_end_date > $yactual_start_date){
                                            $testingdays_a       =  round((($yactual_end_date - $yactual_start_date) / 86400),0);
