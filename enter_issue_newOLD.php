...
// -------------------------------------
   ...
   if ($rowcntx == 1)   {
       ...
       print("</font>
           ...
           <caption>$captn</caption>
            <tr>
               ...
               <td bgcolor=\"#99CCFF\" align=\"center\" style=\"width=40% height:25px;\"><font color=\"#330099\">Enter Issue Title</font></td>
       ...
       for ($x=1;$x<=$num_records; ++$x) {
	        print("
                <tr>
		         <td align=\"center\" valign=\"middle\" bgcolor=\"#E8E8E8\" rowspan=\"2\" style=\"height:175px;\">
		          <input type=\"hidden\" name=\"new[$x]\" value=\"$x\">
		         </td>
            ");
            print("
	             <td bgcolor=\"#FFFF00\" align=\"left\" style=\"width:40%; word-wrap: break-word; word-break:break-all;\">
	              <div style=\"width: 40%; word-wrap: break-word; word-break:break-all;\">
            ");
            if (isset($zdesc)) {
                print("<textarea name=\"new_issue_desc[$x]\" rows=\"10\" cols=\"100%\">$zdesc</textarea>");   
            } else {
                print("<textarea name=\"new_issue_desc[$x]\" rows=\"10\" cols=\"100%\"></textarea>");   
            }
            //print("</td>");
            ...
            print("    </select>
                     ...
                     <tr>
            ");  
            print("  <td align=\"left\" valign=\"middle\" bgcolor=\"#FFFF00\" rowspan=\"2\">
                       <font color=\"#000000\"> 
            ");
           ...
           while($row = mysql_fetch_row($mysql_data)) {
                 ...
                 print(" 
                  ...
                  <tr>
                   ...
                   <td bgcolor=\"#CCCCCC\" align=\"left\" valign=\"top\" style=\"width:100%; height:150px; word-wrap: break-word; word-break:break-all; scroll-x: auto;\">
                    <font color=\"#000000\">
   	                 <div style=\"word-wrap: break-word; word-break:break-all; width:100%; height:150px; overflow-y: auto; background-color: #CCCCCC;\">
