	   ...
	   if (strlen($new_issue_note[$key]) >= 1){
	      ...
	      if (
            ...
            $query ="INSERT into ".$name.".issue_history(issue_id,issue_assignee,issue_note_dt,issue_note,
                     ...
                     VALUES('$new_issue_id[$key]','$new_issue_assignee[$key]','$yentry_dt',
...
print("<html>
        <head>
         ...
         <script type=\"text/javascript\">
          function reload(form){
            ...
            self.location='enter_issue_updates_3z.php?rot_id=' + val + '&start=1&pdp=' + pdpval + '&num_records=' + numrval + '&v_issue_id=' + w_issue_id + '&v_issue_hist_id' + w_issue_hist_id ;
          }
         </script>
        ...
        <body>
         <div id=\"content\" >
          <form id=\"thisfrm\" method=\"post\" action=\"./enter_issue_updates_3z.php?v_issue_id=$v_issue_id&&v_issue_hist_id=$v_issue_hist_id&&v_usr=$usr&&pdp=$pdp\">
           <table border='0'>
            <tr>
     ...
     for ($x=1;$x<=$num_records; ++$x) {
         ...
         print("   </select>
                   ...
                   <input type=\"hidden\" name=\"z_issue_id\" value=\"$v_issue_id\">
                   <input type=\"hidden\" name=\"z_issue_hist_id\" value=\"$v_issue_hist_id\">
                   <input type=\"hidden\" name=\"z_usr\" value=\"$usr\">
                  </td>
                 </tr>    
         ");
         //=============================================================================================
         ...
         //===============================================
         //print("         
	     //         <td align=\"center\" valign=\"middle\" bgcolor=\"#FFFF00\" style=\"width:600px; word-wrap: break-word; word-break:break-all;\">
	     //          <div style=\"width: 600px; word-wrap: break-word; word-break:break-all;\">
	     //");
         //if ($start == 1) {        
         //    print(" <textarea name=\"new_issue_note[$x]\" rows=\"10\" style=\"width: 575px;\">$zdesc</textarea> ");
         //} else {
         //    print(" <textarea name=\"new_issue_note[$x]\" rows=\"10\" style=\"width: 575px;\">$zissue_note</textarea> ");
         //}         
	     //print("  </div>
         //        </td>
         //");
     ...
     while($row21 = mysql_fetch_row($mysql_data21)) {
        ...
        //}
        print("            
    	            <td bgcolor=\"#E8E8E8\" align=\"left\" style=\"width:600px; height:150px; word-wrap: break-word; word-break:break-all; scroll-x: auto;\">
    	              <font color=\"#000000\">
    	               <div style=\"word-wrap: break-word; word-break:break-all; width:600px; height:150px; overflow-y: auto; background-color: #E8E8E8;\">
...
// End of HTML
print("
                   <input type=\"submit\" name=\"submit\" value=\"Issues List\" onclick=\"parent.document.all['content2'].innerHTML='&lt;iframe src=&quot;enter_issue_existing_2z.php?v_issue_id=$xid2&&v_issue_hist_id=$xid3&&v_usr=$usr&&pdp=$pdp&&start=1&quot; width=&quot;100%&quot; height=&quot;100%&quot; scrolling=&quot;auto&quot; frameborder=&quot;no&quot;&gt;&lt;/iframe&gt;'\">
