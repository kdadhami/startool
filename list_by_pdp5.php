     ...
     print("        
       ...
       while($row80 = mysql_fetch_row($mysql_data80)) {
             ...
             for ($s=1;$s<=$isue_typ_cnt ; ++$s) {
                  ...
                  //$p_total[$p_id][$s]                        = $p_total[$p_id][$s] + $pdp_isue_typ_cnt_i[$pdp_isue_cnt][$s] + $pdp_isue_typ_cnt_u[$pdp_isue_cnt][$s];
                  ...
                  //print($xid."-".$s."-".$isue_typ_used[$xid][$s]."<br>");
             }
             //***print("<br>"); 
        }       
        $p_total = array(); 
       ...
       //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
           ...
           if ($seq == 1) {         
           print("
            <table border='0' scroll=\"yes\" style=\"width: 200%; border-style:solid; border-color:#CCCCCC;\" >
            <!--<caption>$captn</caption>-->
             <tr>
               ...
               <td bgcolor=\"#99CCFF\" align=\"center\" width=\"200px\"><font color=\"#330099\">Create Details</font></td>
               <td bgcolor=\"#99CCFF\" align=\"center\" width=\"200px\"><font color=\"#330099\">Last Update</font></td>
               <td bgcolor=\"#99CCFF\" align=\"center\" width=\"50px\"><font color=\"#330099\">Updates</font></td>
           ");
           for ($st=1;$st<=$isue_typ_cnt ; ++$st) {
                print("    
                       <td bgcolor=\"#99CCFF\" align=\"center\" style=\"word-wrap: break-word; word-break:break-all; width:75px;\">
                        <font color=\"#330099\">
                         $isue_typ[$st]
                        </font>
                       </td>
           ...
           //$selctn_u1 = str_replace("<br>", "\n", $selctn_u);
           //print($selctn_u1);
           }
           print("
                  <tr>
                   <td bgcolor=\"#FFC000\" align=\"center\" width=\"50px\">
                    <font color=\"#330099\">
                     $seq
                    </font>
                   </td> 
                   <td bgcolor=\"#99CCFF\" align=\"center\" width=\"50px\">
                    <font color=\"#330099\">
                   ...
                   <td bgcolor=\"#E8E8E8\" align=\"left\" valign=\"top\" style=\"word-wrap: break-word; word-break:break-all; width:200px;\">
                    <font color=\"#330099\">
                     <p style=\"word-wrap: break-word; word-break:break-all; width:200px;\">
                      Created By: $xcreated_by<br>
                      Create Date: $xcreate_dt<br>
                      Department: $dept_c<br><br>
                      Description:<br>
                      $xissue_desc<br><br>
                      Root Cause Selected:<br>
                      $selctn_c
                     </p>
                    </font>
                   </td>
                   <td bgcolor=\"#E8E8E8\" align=\"left\" valign=\"top\" style=\"word-wrap: break-word; word-break:break-all; width:200px;\">
                    <font color=\"#330099\">
                     <p style=\"word-wrap: break-word; word-break:break-all; width:200px;\">
                      Last Updated By: $xissue_assignee<br>
                      Last Update Date: $xdt<br>
                      Department: $dept_u<br><br>
                      Description:<br>
                      $xissue_note<br><br>
                      Root Cause Selected:<br>
                      $selctn_u
          ...
          for ($p=1;$p<=$isue_typ_cnt ; ++$p) {
               print(" <td bgcolor=\"#FFFFFF\" align=\"center\" valign=\"middle\" style=\"word-wrap: break-word; word-break:break-all; width:75px;\">
                        <font color=\"#330099\">
               ");
               //print("&nbsp&nbsp ".$pdp_isue_typ_id[$xid2][$p]."<a>&nbsp&nbsp</a>".$isue_typ[$p]."<br>");
               print($pdp_isue_typ_id[$xid2][$p]);
               print("  </font>
                       </td>
               ");     
          }
          print("         
           ...
           for ($t2=1;$t2<=$isue_typ_cnt ; ++$t2) {
            ...
            print("
                     ...
                     <td bgcolor=\"#FFFF00\" valign=\"middle\" align=\"center\">                
	                  <font color=\"#330099\"> 
                       $ptotal
                      </font>               
                     </td>
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./list_by_pdp5.php\">
