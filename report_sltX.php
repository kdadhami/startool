...
if ($start == 1) {
   ...
   print("
    ...
    for ($h=$qry0;$h>=1;$h=$h-1) {
		 ...
		 if ($h == $qry0){
		     $dsp_dt_range = "(YYY-MM-DD)<br>".$beg_dt." TO TODATE"; 
		 }
		 if (($h <> 1) && ($h <> $qry0)){
         ...
         for ($h=$qry0;$h>=1;$h=$h-1) {
              ...
              $query_pdp1y = "         SELECT sum(c.issue_count)
                                        ...
                                        WHERE a.pdp         = b.pdp 
                                          ...
                                          AND ((a.pdp_launch >= '$xldatey' and a.pdp_launch <= '$xldate2y') or (a.pdp_launch = '0000-00-00' and a.pdp_launch > '2010-09-01'))
		     							 AND a.pdp = c.pdp
		     							 AND trim(upper(c.issue_area)) = trim(upper('$darea[$d]'))
 		        				    GROUP BY c.issue_area
                            ";
...
if ($found == 0) {
   ...
   print("<form method=\"post\" action=\"./report_sltX.php\"> 
           <table border='0' scroll=\"yes\">
            <caption>$captn</caption>
              <tr>
