...
print("<html>
        ...
        <body>
         <div id=\"content\" >
          <form id=\"thisfrm\" method=\"post\" action=\"./issue_updates_all.php?v_issue_id=$v_issue_id&&v_issue_hist_id=$v_issue_hist_id&&v_usr=$usr&&pdp=$pdp\">
           <table border='0'>
            <tr>
       ...
       print("</font>
           ...
           <table border='0' scroll=\"yes\">
            ...
            <!--<tr>
             <td bgcolor=\"#0000CC\" align=\"center\" valign=\"middle\" colspan=\"6\"><font color=\"#FFFFFF\"><strong>ENTER UPDATES</strong></font></td>
            </tr>-->
            <tr>
	...
	//	 ");
     ...
     if ($rowcnt == 0) {
         print("
                <td bgcolor=\"#0000CC\" align=\"center\" valign=\"middle\" colspan=\"6\"><font color=\"#FFFFFF\"><strong>NO PREVIOUS UPDATES EXISTS FOR $usr</strong></font></td>
         ...
         print("
                <td bgcolor=\"#0000CC\" align=\"center\" valign=\"middle\" colspan=\"5\"><font color=\"#FFFFFF\"><strong>$rowcnt PREVIOUS UPDATES EXISTS FOR $usr</strong></font></td>
         ...
         for ($sur=1;$sur<=$issue_sur_cnt; ++$sur){
          ...
          ");    
           ...
           while($row = mysql_fetch_row($mysql_data)) {
                 ...
                 print("   <tr valign=\"top\">
                            <td bgcolor=\"#0000CC\" align=\"center\" valign=\"middle\" colspan=\"5\"><font color=\"#FFFFFF\"><strong>MASTER RECORD</strong></font></td>
...
// End of HTML
print("
                   <input type=\"submit\" name=\"submit\" value=\"Issues List\" onclick=\"parent.document.all['content2'].innerHTML='&lt;iframe src=&quot;existing_issues_all.php?v_issue_id=$xid2&&v_issue_hist_id=$xid3&&v_usr=$usr&&pdp=$pdp&&start=1&quot; width=&quot;100%&quot; height=&quot;100%&quot; scrolling=&quot;auto&quot; frameborder=&quot;no&quot;&gt;&lt;/iframe&gt;'\">
