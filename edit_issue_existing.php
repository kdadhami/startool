...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       print("  <form method=\"post\" action=\"./edit_issue_existing.php\" id=\"thisfrm\">
                 ...
                 <table border='0' scroll=\"yes\">
                  <caption>$captn</caption>
                   <tr>
                     ...
                     <td bgcolor=\"#ECE5B6\" align=\"center\" rowspan=\"2\"><font color=\"#330099\">Delete</font></td>
                   </tr>
                   <tr>
      ...
      $query = "select issue_id,pdp_id,issue_desc,created_by,created_on,issue_area_id 
                  from ".$name.".issues 
                 where pdp_id = '$xid'"; //and created_by = '$usr' ";
      ...
      if ($rowcnt <> 0){           
          $seq = 0;
                 ...
                 if ($rowcnth == 0 && $xcreated_by == $usr) {
                     print("
                            <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\">
                             <font color=\"#000000\">
                              <input type=\"checkbox\" name=\"delete[$xid2]\" value=\"Delete\">
                             </font>
                            </td>
                     ");                     
                 } else {
           ...
           print("<script type=\"text/javascript\">
                    document.forms['thisfrm'].action=\"./edit_issue_existing.php\";
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./edit_issue_existing.php\">
           <table border='0' scroll=\"yes\">
            <tr>
