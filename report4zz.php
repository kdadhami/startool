...
$xreport_pth = "./reports/";
$xreport_nam = "SUMMARY REPORT-".$ydate3.".htm";
//print ($reportname); 

   ...
   while($rowp  = mysql_fetch_row($mysql_datap)) {
         ...
         if ($total_pdp == 1){
             for ($pc=1;$pc<=$pcol;++$pc) {
                  ...
                  if ($pc == 0 || $pc == 3 || $pc == 4 || $pc == 6 || $pc == 7 || $pc == 8 || $pc == 9 || $pc == 23){
                      $pdp_head_use[$pc] = 0;
                      $pc3a = $pc3a + 1;
                  } else {
                      //if ($pc <> 3){
        ...
        while($rowpae  = mysql_fetch_row($mysql_datapae)) {
              ...
              for ($pc=$paestart;$pc<=$paeend;++$pc) {
                   ...
                   if ($tp == 1){
                       ...
                       if ($pc == $paestart || $pc2 == 2  || $pc2 == 3 || $pc2 == 4 || $pc2 == 7  || $pc2 == 8  || $pc2 == 9  || $pc2 == 10  || $pc2 == 13  || $pc2 == 14){
        ...
        while($rowpwe  = mysql_fetch_row($mysql_datapwe)) {
              ...
              for ($pc=$pwestart;$pc<=$pweend;++$pc) {
                   ...
                   if ($tp == 1){
                       ...
                       if ($pc == $pwestart || $pc2 == 2  || $pc2 == 3  || $pc2 == 4  || $pc2 == 5){
                           $pwe_head_use[$pc] = 0;
                           //if ($pc <> 0){
                               $pc3c = $pc3c + 1;
                           //}           // Counter should be used only when $pc <> 0
...
if ($found == 0) {
    ...
    print("<form method=\"post\" action=\"./report4zz.php\">
   ...
   $query = "  select saved_report_id,report_name,filters,report_path,etl_id,report_timestamp,ran_by from ".$name.".saved_reports
                where rtrim(report_name) = 'SUMMARY REPORT'
                  and ran_by = '$usr'
