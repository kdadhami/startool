...
$twoweeks
$twoweeks_back   = $new_dt - (86400*14);
$twoweeks_forwar = $new_dt + (86400*14);
...
if ($submit == "Submit") {
    ...
    if (isset($delete)) {
	    while (list($key) = each($delete)) {
			   ...
			   $ycomments    = "All previous entries for activity ".$ymilestone[$key]." are truncated by ".$usr.". Work Effort Activity ".$ymilestone[$key]." is now initialized."; 
			   $yphase_desc  = "Work Effort Activity Initialized";
               $query110 = "INSERT into ".$name.".pdp_logs(pdp_id,issue_area,updated_by,updated_on,comments,module,action,followup,phase,phase_desc)
                            VALUES('$pdp_id','$uissue_area','$usr',current_timestamp,'$ycomments','TRACKER',0,1,'WORK EFFORT','$yphase_desc')";
			   //print($query110."<br>");
   ...
   if ($rowcntx == 1) {
      ...
      $captn = "Work Effort Status";
           print(" 
               ...
               <table id=\"theTable\" border='0' align=\"center\" width=\"90%\">
                ...
                <tr>
                 ...
                 <td bgcolor=\"#CCCC99\" align=\"center\" rowspan=\"2\"><font color=\"#330099\">Initialize</font></td>
                </tr>
                <tr>
           ...
           while($row44 = mysql_fetch_row($mysql_data44)) {
			    ...
			    ");
				print($xpdp_launch. " | ".$new_dt." | ".$twoweeks_back." | ".$twoweeks_forward."<br>");
                if(($xpdp_launch >= $twoweeks_back) and ($xpdp_launch <= $twoweeks_forward)){
                  print("				
                       <td align=\"center\" valign=\"middle\" bgcolor=\"$colr1\">
                         <font color=\"#330099\">
			 			 <input type=\"hidden\" name=\"ymilestone[$ymilestone_id]\" value=\"$ymilestone\">
