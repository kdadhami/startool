...
print("<html>
     ...
     // Select all history for given issue done by user's department
     ...
     for ($x=1;$x<=$num_records; ++$x) {
	     ...
	     ");
         if ($start == 1) {        
             print(" <textarea name=\"new_issue_note[$x]\" rows=\"15\" style=\"width: 100%; word-wrap: break-word; word-break:break-all;\">$zdesc</textarea> ");
         } else {
             print(" <textarea name=\"new_issue_note[$x]\" rows=\"15\" style=\"width: 100%; word-wrap: break-word; word-break:break-all;\">$zissue_note</textarea> ");
         }         
	     print("  </div>
                 </td>
                 <td>
     ...
     if ($rowcnt == 0) {
         //print("
         //       <td bgcolor=\"#CCCCCC\" align=\"center\" valign=\"middle\" colspan=\"4\"><font color=\"blue\"><strong>NO PREVIOUS UPDATES FOUND</strong></font></td>
         //");                              
     } else {
         print("
