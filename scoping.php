...
$xreport_pth = "./reports/";
$xreport_nam = "SCOPING SUMMARY-".$ydate3.".htm";
//print ($reportname); 
//Start of HTML
//================================================================================================================
   ...
   if ($rowcntx > 0) {
       ...
       while($rowttl = mysql_fetch_row($mysql_datax)) {
             ...
             if ($seq == 1) {
                 ...
                 $captn = "SCOPING SUMMARY";
                 print("<div id=\"Two\" class=\"cont2\">
                          <div class=\"wrapper2\">
                           <!--<div class=\"div2\">-->                          
                            <table id=\"theTable\" scroll=\"yes\" style=\"border-style:solid 1px; border-color:#CCCCCC; width=90%;\" >
                             <caption >$captn</caption>
                              <tr class=\"headerRow\">
                 ");
                 for ($s=1;$s<=$scnt;++$s) {
...
if ($found == 0) {
    ...
    print("<form method=\"post\" action=\"./scoping.php\">
   ...
   $query = "  select saved_report_id,report_name,filters,report_path,etl_id,report_timestamp,ran_by from ".$name.".saved_reports
                where rtrim(report_name) = 'SCOPING SUMMARY'
                  and ran_by = '$usr'
