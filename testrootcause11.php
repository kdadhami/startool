...
set_time_limit(0);
       ...
       while($row69         = mysql_fetch_row($mysql_data69)) {
             $icnt0         = $icnt0 + 1;
             $iid0[$icnt0]  = stripslashes($row69[0]);  //Issue_id
             $ityp0[$icnt0] = stripslashes($row69[1]);  //issue_type
             $iccd0[$icnt0] = trim(stripslashes($row69[3]));  //issue_class_code
             //print($icnt0." - ".$iid0[$icnt0]." - ".$ityp0[$icnt0]." - ".$iccd0[$icnt0]."<br>");
             //$tcnt[$icnt] = 0;
       }
...
for ($i=1;$i<=$icnt0 ; ++$i) {
     ...
     print(" <td align=\"center\" valign=\"middle\" style=\"width: 50px; background-color: $colr0;\">
              <font color=\"#330099\">
               $ityp0[$i]
              </font>
             </td> 
...
");        
       ...
       $query78      = "select pdp_id,pdp_desc,pdp_period_id 
                          from ".$name.".pdp ";     //where a.pdp_period_id = b.pdp_period_id pdp_period_id <> 0 pdp_desc = '2010-0556'
       ...
       //               order by issue_class_id desc,issue_seq asc"; 
       ...
       //print ("<tr> 
       //         <td bgcolor=\"#FFFFCC\" colspan=\"8\" align=\"right\" valign=\"middle\">
       //          <font color=\"#330099\">
       ...
       //print ("
       //        <tr> 
       //         <td bgcolor=\"#99FF99\" colspan=\"8\" align=\"right\" valign=\"middle\">
       //          <font color=\"#330099\">
            ...
            for ($l=1;$l<=$pimax[$p] ; ++$l) {
                 ...
                 if ($l <> 1) {
                     ...
                     print("<tr>
                             ...
                             <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\" style=\"width: 50px; border: 1px solid #FF0000;\">
                              <font color=\"#330099\">
                               $xpdp_prd
                              </font>
                             </td> 
                             ...
                             <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\"  valign=\"middle\" style=\"width: 150px; border: 1px solid #FF0000;\">
                              <font color=\"#330099\">
                               $uudesc
                              </font>
                             </td>                                        
                 ...
                 for ($i=1;$i<=$icnt ; ++$i) {
                      ...
                      print("
                             <td align=\"center\" valign=\"middle\" style=\" background-color: $colr; width: 50px; border: 1px solid $colrx;\">
                              <font color=\"#330099\">
                               $uvalx
                              </font>
                             </td>                       
       ...
       // =============================================================================================
       unset($iid,$ityp,$tcnt,$piid,$pidesc,$pitid,$pityp,$pimax,$puid,$pudesc,$putid,$putyp,$pi,$vval,$ytotl,$stotl,$rtotl,$picby,$picon,$picdt,$pucby,$pucon,$pudt);
       print(" <!--</tr>
              </table>-->
       ");       
       }
