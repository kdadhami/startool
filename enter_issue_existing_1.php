...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       print("
         <form method=\"post\" action=\"./enter_issue_existing_2.php\" id=\"thisfrm\">
       ...
       print("</font>
           ...
           <table border='0' scroll=\"yes\">
            <caption>$captn</caption>
             <tr>
               <td bgcolor=\"#FF0000\" align=\"center\" valign=\"middle\" rowspan=\"2\"><font color=\"#FFFFFF\">Click<br>Issue No.</font></td>
               <td bgcolor=\"#99CCFF\" align=\"center\" valign=\"middle\" rowspan=\"2\"><font color=\"#330099\" style=\"width: 300px;\">Description (Max 500 Chars)</font></td>
           ...
           print("
                 <tr>
                   ...
                   <td bgcolor=\"#CCFFFF\" align=\"left\" style=\"width: 300px; word-wrap: break-word; word-break:break-all;\">
                    <font color=\"#330099\">
                     <p style=\"width: 300px; word-wrap: break-word; word-break:break-all;\">
                      $xissue_desc
                     </p>
                    </font>
                   </td>
       ...
       ");
        ...
        print("<script type=\"text/javascript\">
                document.forms['thisfrm'].action=\"./enter_issue_existing_1.php\";
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./enter_issue_existing_1.php\">
           <table border='0' scroll=\"yes\">
            <tr>
