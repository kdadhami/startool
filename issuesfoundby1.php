...
$xreport_pth = "./reports/";
$xreport_nam = "ISSUE SUMMARY REPORT (RA=YES & UAT=YES)-".$ydate3.".htm";
//print ($reportname); 
//Start of HTML
//================================================================================================================
...
if ($start == 1) {
   ...
   if (($cnd1 == 1) && ($cnd2 == 2) && ($cnd3 == 1)) {            
        ...
        $wherex  = " where a.etl_id = '$yetl_id'
                       ...
                       and a.pdp = b.pdp
                       and (b.short_desc = ('RA') and b.tested = ucase('$ra_ind'))
                       and (b.short_desc = ('UAT') and b.tested = ucase('$uat_ind'))";
        $queryx  = $selectx.$fromx.$wherex.$orderbyx;               
   } 
   ...
   if ($rowcntx > 0) {
       ...
       while($rowttl = mysql_fetch_row($mysql_datax)) {
             ...
             if ($seq == 1) {
                        ...
                        <div id=\"One\" class=\"cont\"> 
                         <table>
                          ...
                          <tr>
                           ...
                           <th bgcolor=\"#FFFFCC\" align=\"left\" valign=\"middle\" style=\"word-wrap: break-word; word-break:break-all; width:300px;\">
                            <font color=\"#330099\">
                             ISSUE SUMMARY REPORT (RA=YES & UAT=YES)
                            </font>
                           </th>
                          </tr>                                         
                          <tr>
                 ...
                 $captn = "ISSUE SUMMARY REPORT (RA=YES & UAT=YES)";
   ...
   $xreport_name = "ISSUE SUMMARY REPORT (RA=YES & UAT=YES)"; 
...
if ($found == 0) {
    ...
    print("<form method=\"post\" action=\"./issuesfoundby1.php\">
    ...
    print("
              ...
              <input type=\"hidden\" name=\"ra_ind\" value=\"YES\"> 
              <input type=\"hidden\" name=\"yshort_desc2\" value=\"UAT\">
              <input type=\"hidden\" name=\"uat_ind\" value=\"YES\"> 
             </td>
            </tr>
    ");         
   ...
   $query = "  select saved_report_id,report_name,filters,report_path,etl_id,report_timestamp,ran_by from ".$name.".saved_reports
                where rtrim(report_name) = 'ISSUE SUMMARY REPORT (RA=YES & UAT=YES)'
                  and ran_by = '$usr'
