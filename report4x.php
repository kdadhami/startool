   ...
   if ($rowcntx > 0) {
       ...
       while($rowttl = mysql_fetch_row($mysql_datax)) {
             ...
             if ($seq == 1) {
                 ...
                 ");
                 $captn = "FULL EXTRACT";
                 print("<table scroll=\"yes\" style=\"border-style:solid 1px; border-color:#CCCCCC; width=300%;\" >
                         <caption >$captn</caption>
                          <tr>
                 ");
                 for ($s=1;$s<=$scnt;++$s) {
                 ...
                 for ($d=1;$d<=$dcnt;++$d) {
                      print("
                             <td align=\"center\" valign=\"middle\" style=\"background-color: #CCFFFF; word-wrap: break-word; word-break:break-all; width:125px;\">
                              <font color=\"#000000\">
                              </font>
                             </td>
                      ");                      
                 ...
                 for ($i=1;$i<=$icnt ; ++$i) {
                      ...
                      print(" <td align=\"center\" valign=\"middle\" style=\"width: 125px; background-color: #99CCFF;\">
                               <font color=\"#330099\">
                                $irgrp[$i]
                               </font>
                              </td> 
...
if ($found == 0) {
    ...
    print("<form method=\"post\" action=\"./report4x.php\">
