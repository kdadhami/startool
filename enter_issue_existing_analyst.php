...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       print("  <form method=\"post\" action=\"./enter_issue_existing_analyst.php\" id=\"thisfrm\">
      ...
      if (($rowcnt <> 0) || ($rowcnt2 <> 0)){           
          ...
          $seq = 0;
                 ...
                 print("
                        <tr>
                         <td bgcolor=\"#E8E8E8\" align=\"center\" valign=\"middle\" rowspan=\"2\">
                          <font color=\"#330099\">
	                       <a href=\"#\" onclick=\"parent.document.all['content2'].innerHTML='&lt;iframe src=&quot;enter_issue_updates_analyst.php?v_issue_id=$xid2&&v_issue_hist_id=$xid3&&v_usr=$usr&&pdp=$pdp&&uissue_area=$uissue_area&quot; width=&quot;100%&quot; height=&quot;100%&quot; scrolling=&quot;auto&quot; frameborder=&quot;no&quot;&gt;&lt;/iframe&gt;'\">
                            $xid2
           ...
           print("<script type=\"text/javascript\">
                    document.forms['thisfrm'].action=\"./enter_issue_existing_analyst.php\";
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./enter_issue_existing_analyst.php\">
           <table border='0' scroll=\"yes\">
            <tr>
