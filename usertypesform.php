...
if (isset($new)) {
	while (list($key) = each($new)) {
            ...
            //}
             if ($insert_ind == 0){
                 $query ="INSERT into ".$name.".user_types(user_type,user_type_ind,menu,issue_area_id,lockdown)
                          VALUES('$new_user_type[$key]',1,'$new_menu[$key]','$new_issue_area_id[$key]','$new_lockdown[$key]')";
                 //print($query);         
           ...
           <form method=\"post\" action=\"./usertypesform.php\">
            <table border='0' align=\"center\" scroll=\"yes\">
             ...
             <tr> 
               ...
               <td align=\"center\" bgcolor=\"#99CCFF\"><font color=\"#330099\">Lockdown</font></td>
...
$query = "select a.user_type_id,a.user_type,a.user_type_ind,a.menu,a.issue_area_id,b.issue_area,lockdown 
            from ".$name.".user_types a, ".$name.".issue_areas b 
           where a.issue_area_id = b.issue_area_id
          order by a.lockdown,a.issue_area_id ";
$mysql_data = mysql_query($query, $mysql_link) or die ("Could not query: ".mysql_error());
