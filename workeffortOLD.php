...
if ($start == 1) {
   ...
   if ($rowcntx > 0) {
       ...
       while($rowttl = mysql_fetch_row($mysql_datax)) {
             ...
             //             if ($h == 11) {
             //                 if ($r == 1) {
             //                     $hval[11] = "Total In Scope = ".$inscpcnt."<br>".$inscpprc."%"; 
             //                 }
             //                 if ($r == 2) {
             //                     $hval[11] = "Total Out of Scope = ".$outscpcnt."<br>".$outscpprc."%"; 
             //                 }
             //                 if ($r == 3) {
             //                     $hval[11] = "Total Not Set = ".$notsetcnt."<br>".$notsetprc."%"; 
             //                 }
             //                 if ($r == 4) {
             //                     $hval[11] = "Total = ".$totscpcnt; 
             //                 }                              
             //            }
             //            if ($h == 12) {
             //                 if ($r == 1) {
             //                     $hval[12] = "Total HIGH = ".$comphcnt."<br>".$comphprc."%"; 
             //                 }
             //                 if ($r == 2) {
             //                     $hval[12] = "Total MEDIUM = ".$compmcnt."<br>".$compmprc."%"; 
             //                 }
             //                 if ($r == 3) {
             //                     $hval[12] = "Total LOW = ".$complcnt."<br>".$complprc."%"; 
             //                 }
             //                 if ($r == 4) {
             //                     $hval[12] = "Total NOT SET = ".$compncnt."<br>".$compnprc."%"; 
             //                 }                              
             //                 if ($r == 5) {
             //                     $hval[12] = "Total = ".$comptcnt; 
             //                 }                               
             //             }                          
             //             if ($h == 13) {
             //                 if ($r == 1) {
             //                     $hval[13] = "Total HIGH = ".$revnhcnt."<br>".$revnhprc."%"; 
             //                 }
             //                 if ($r == 2) {
             //                     $hval[13] = "Total MEDIUM = ".$revnmcnt."<br>".$revnmprc."%"; 
             //                 }
             //                 if ($r == 3) {
             //                     $hval[13] = "Total LOW = ".$revnlcnt."<br>".$revnlprc."%"; 
             //                 }
             //                if ($r == 4) {
             //                     $hval[13] = "Total NOT SET = ".$revnncnt."<br>".$revnnprc."%"; 
             //                 }                              
             //                 if ($r == 5) {
             //                     $hval[13] = "Total = ".$revntcnt; 
             //                 }                               
             //             }
             //             if ($h == 14) {
             //                 if ($r == 1) {
             //                     $hval[14] = "Total HIGH = ".$custhcnt."<br>".$custhprc."%"; 
             //                 }
             //                 if ($r == 2) {
             //                     $hval[14] = "Total MEDIUM = ".$custmcnt."<br>".$custmprc."%"; 
             //                 }
             //                 if ($r == 3) {
             //                     $hval[14] = "Total LOW = ".$custlcnt."<br>".$custlprc."%"; 
             //                 }
             //                 if ($r == 4) {
             //                     $hval[14] = "Total NOT SET = ".$custncnt."<br>".$custnprc."%"; 
             //                 }                              
             //                 if ($r == 5) {
             //                     $hval[14] = "Total = ".$custtcnt; 
             //                 }                               
             //             }
             //             if ($h == 15) {
             //                 if ($r == 1) {
             //                     $hval[15] = "Total HIGH = ".$pasthcnt."<br>".$pasthprc."%"; 
             //                 }
             //                 if ($r == 2) {
             //                     $hval[15] = "Total MEDIUM = ".$pastmcnt."<br>".$pastmprc."%"; 
             //                 }
             //                 if ($r == 3) {
             //                     $hval[15] = "Total LOW = ".$pastlcnt."<br>".$pastlprc."%"; 
             //                 }
             //                 if ($r == 4) {
             //                     $hval[15] = "Total NOT SET = ".$pastncnt."<br>".$pastnprc."%"; 
             //                 }                              
             //                 if ($r == 5) {
             //                     $hval[15] = "Total = ".$pasttcnt; 
             //                 }                               
             //             }                                                    
             //             print(" <td align=\"center\" valign=\"middle\" style=\"width: 125px; background-color: #FFFFCC;\">
             //                      <font color=\"#FF0000\">
...
if ($found == 0) {
    ...
    print("<form method=\"post\" action=\"./workeffort.php\">
