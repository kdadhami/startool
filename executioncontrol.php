...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       $query42 = "select execution_id,pdp_id,start_date,end_date,updated_by,invoice_count,bill_run_count,
                          ppw_update,comments,launch_ind,defects,running_comments,actual_end_date,back_to_build
                     from ".$name.".pdp_execution where pdp_id = '$xid'"; 
       ...
       while($row42 = mysql_fetch_row($mysql_data42)) {
               ...
               $yactual_end_date = stripslashes($row42[12]);
               $yback_to_build   = stripslashes($row42[13]);
               if (!empty($ystart_dt)){
               ...
               print("  </select>
                      ...
                      <tr>
                       <td bgcolor=\"#99CCFF\" align=\"left\"><font color=\"#330099\">Back To Build</font></td>
                       <td align=\"left\" valign=\"middle\" bgcolor=\"#CCFFFF\" style=\"width:300px;\">
                        <select align=\"left\" name=\"yback_to_build[$yid]\">
               ");
               for ($n=1;$n<=$btb;++$n) {
                     if (($ybtb[$n] == $yback_to_build-1) || ($ybtb[$n] == $yback_to_build) || ($ybtb[$n] == $yback_to_build+1) ) {
                         if ($yback_to_build == $ybtb[$n]){
                             print(" <option selected value=\"$ybtb[$n]\">$ybtb[$n]</option> ");
                         } else {
                             print(" <option value=\"$ybtb[$n]\">$ybtb[$n]</option> ");
                         }
                     }   
               }                         
               print("  </select>
              ...
              <table border='0' align=\"left\" >
                ...
                <tr>
                 <td bgcolor=\"#CCFFFF\" align=\"left\" valign=\"top\" rowspan=\"13\" style=\"word-wrap: break-word; word-break:break-all; width:500px; height:300px;  scroll-x: auto;\">
                  <font color=\"#000000\">
                   <textarea cols=\"1\" rows=\"1\" readonly=\"readonly\" style=\"word-wrap: break-word; word-break:break-all; width:500px; height:300px;\" >
                    $zrunning_log
                   </textarea>
                  </font>
                 </td>                  
