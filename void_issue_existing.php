...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       print("  <form method=\"post\" action=\"./void_issue_existing.php\" id=\"thisfrm\">
      ...
      if ($rowcnt <> 0){           
          $seq = 0;
           ...
           print("<script type=\"text/javascript\">
                    document.forms['thisfrm'].action=\"./void_issue_existing.php\";
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./void_issue_existing.php\">
           <table border='0' scroll=\"yes\">
            <tr>
