...
if ($submit == "Submit") {
    if (isset($delete)) {
	    ...
	    while (list($key) = each($delete)) {
		       $query = "DELETE FROM ".$name.".issue_history WHERE issue_history_id = '$key' ";
		       //print($query);
...
// ===========================================  MAIN START ============================================
         ...
         // 	          $new_issue_area_id[$key]     = addslashes($new_issue_area_id[$key]);	        
          ...
          // -------------- >>> Extracting Details of last update -- Start
          ...
          // -------------- >>> Extracting Details of last update -- End

// =====================================   HTML START ====================================
$captn = "Edit Existing Updates";
//print("$captn");
...
print("<html>
        ...
        <body>
         <div id=\"content\" >
          <form id=\"thisfrm\" method=\"post\" action=\"./edit_issue_updates.php?v_issue_id=$v_issue_id&&v_issue_hist_id=$v_issue_hist_id&&v_usr=$usr&&pdp=$pdp\">
           <table border='0'>
            <tr>
       ...
       print("</font>
           ...
           <table border='0' width=\"100%\">
            ...
            <tr>
               ...
               <td bgcolor=\"#99CCFF\" align=\"center\" style=\"width: 200px\"><font color=\"#330099\">Notes (Max 2000 chars)</font></td>
               ...
               <td bgcolor=\"#99CCFF\" align=\"center\"><font color=\"#330099\">Contributing Factor</font></td> 
               <td bgcolor=\"#99CCFF\" align=\"center\"><font color=\"#330099\">Updated</font></td>
               <td bgcolor=\"#ECE5B6\" align=\"center\"><font color=\"#330099\">Delete</font></td>
            </tr>
      ");

     // Select all history for given issue
     $query      = "select issue_history_id,issue_id,issue_assignee,issue_note_dt,issue_note,issue_area_id 
                      from ".$name.".issue_history 
                     where issue_id = $v_issue_id 
                  order by issue_history_id desc";
     ...
     if ($rowcnt == 0) {
         print("
                <td align=\"center\" colspan=\"8\" valign=\"middle\" bgcolor=\"#CCCCCC\">
    	          <font color=\"#330099\">
                   $usr You have not made any updates in this issue 
                  </font> 
    	        </td>
         ");                              
     }
     // -------------- >>> Display previous Updates Start
     $seq                     = $rowcnt + 1;
     while($row               = mysql_fetch_row($mysql_data)) {
	       ...
	       print("   <tr valign=\"top\">
    	                  ...
    	                  <td align=\"left\" valign=\"middle\" bgcolor=\"#CCFFFF\" style=\"width: 200px; word-wrap: break-word; word-break:break-all;\">
    	                    <font color=\"#330099\">
         ...
         print("    </font>
                    ...
                    <td align=\"center\" valign=\"middle\" bgcolor=\"#E8E8E8\">
    	             <font color=\"#330099\"> 
                        BY<br>$xissue_assignee<br><br>ON<br>$xdt
                     </font> 
                    </td>
         ");
         if ($seq == $rowcnt) {
     ...
     // -------------- >>> Display master record Start
     $query = "select issue_id,pdp_id,issue_desc,created_by,created_on,issue_area_id 
                 from ".$name.".issues 
                where issue_id = '$v_issue_id'";
                  // and created_by = '$usr'
     $mysql_data = mysql_query($query, $mysql_link) or die ("Could not query: ".mysql_error());
     ...
     while($row = mysql_fetch_row($mysql_data)) {
                 ...
                 print("   <tr valign=\"top\">
                           ...
                           <tr valign=\"top\">
    	                    ...
    	                    <td align=\"left\" valign=\"middle\" bgcolor=\"#E8E8E8\" style=\"width: 200px;\">
                             <font color=\"#330099\">
                              <p style=\"width: 200px; word-wrap: break-word; word-break:break-all;\">
                               $xissue_desc
                              </p>
                 ...
                 print("  </font>
                         ...
                         <td align=\"center\" valign=\"middle\" bgcolor=\"#E8E8E8\">
    	                  <font color=\"#330099\"> 
                           BY<br>$xcreated_by<br><br>ON<br>$xcreate_dt
                          </font> 
                         </td>
            ...
            <table border='0'>
                <tr>
                 <td>
                   ...
                   <input type=\"submit\" name=\"submit\" value=\"Issues List\" onclick=\"parent.document.all['content2'].innerHTML='&lt;iframe src=&quot;edit_issue_existing.php?v_issue_id=$xid2&&v_issue_hist_id=$xid3&&v_usr=$usr&&pdp=$pdp&&start=1&quot; width=&quot;100%&quot; height=&quot;100%&quot; scrolling=&quot;auto&quot; frameborder=&quot;no&quot;&gt;&lt;/iframe&gt;'\">
