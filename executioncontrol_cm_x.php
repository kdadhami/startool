...
// -------------------------------------
   ...
   if ($rowcntx == 1) {
       ...
       while($rowx = mysql_fetch_row($mysql_datax)) {
             ...
             // start of HTML
             print("
                   <form method=\"post\" action=\"./executioncontrol_cm_x.php?pdp=$pdp&&start=$start\">
      ...
      if ($rowcnt44 == 0) {
           ...
           while($row44 = mysql_fetch_row($mysql_data44)) {
				...
				//print($ymilestone_id." - ".$eseq_a." - ".$yretrofit_parity." - ".$new_parity_cnt."<br>");
				if ($yoccurance == 0){
				    $eseq_a                        = 0;
				} else {
                ...
                while($row44_a = mysql_fetch_row($mysql_data44_a)) {
                      ...
                      //print($ymilestone_id_a2[$eseq_a]." - ".$eseq_a." - ".$yretrofit_parity_a2[$eseq_a]." - ".$new_parity_cnt."<br>"); 
...
if ($found == 0) {
   print("<form method=\"post\" action=\"./executioncontrol_cm_x.php\">
