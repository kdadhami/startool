   ...
   while($rowp  = mysql_fetch_row($mysql_datap)) {
         ...
         if ($total_pdp == 1){
             for ($pc=1;$pc<=$pcol;++$pc) {
                  ...
                  if ($pc == 0 || ($pc >= 3 && $pc <= 4) || ($pc >= 6 && $pc <= 9) || ($pc >= 12 && $pc <= 18) || $pc == 23){
                      $pdp_head_use[$pc] = 0;
                      $pc3a = $pc3a + 1;
                  } else {
                      $pdp_head_use[$pc] = 1;
   ...
   for ($tp=1;$tp<=$rowcount;++$tp) {
         for ($pc=1;$pc<=$pcol;++$pc) {
                ...
                if ($pc == 10){
				    ...
				    if ($xpdp[$tp][$pc] == "IN SCOPE" && $xpdp[$tp][21] == "YES") {
					    $sum1[$pc][1] = $sum1[$pc][1] + 1;
					}
				    if ($xpdp[$tp][$pc] == "NOT SET" && $xpdp[$tp][21] == "YES" ) {
					    $sum1[$pc][1] = $sum1[$pc][1] + 1; 
					}
				    if ($xpdp[$tp][$pc] == "OUT OF SCOPE" && $xpdp[$tp][21] == "YES") {
					    $sum1[$pc][1] = $sum1[$pc][1] + 1;
					}
				    if ($xpdp[$tp][$pc] == "OUT OF SCOPE" && $xpdp[$tp][21] == "NO") {
					    $sum1[$pc][2] = $sum1[$pc][2] + 1;
					}
				    if ($xpdp[$tp][$pc] == "NOT SET" && $xpdp[$tp][21] == "NO") {
					    $sum1[$pc][3] = $sum1[$pc][3] + 1;
					}
					
  				    //switch ($xpdp[$tp][$pc] && $xpdp[$tp][21]) {
                    //        case ("IN SCOPE" && $xpdp[$tp][21] == "YES"):      // COUNTED AS IN-SCOPE
                    //        $sum1[$pc][1] = $sum1[$pc][1] + 1;
                    //        break;
                    //        case ("NOT SET" && $xpdp[$tp][21] == "YES"):       // ALSO COUNTED AS IN-SCOPE
                    //        $sum1[$pc][1] = $sum1[$pc][1] + 1;
                    //        break;
                    //        case ("OUT OF SCOPE" && $xpdp[$tp][21] == "YES"):  // ALSO COUNTED AS IN-SCOPE
                    //        $sum1[$pc][1] = $sum1[$pc][1] + 1;
                    //        break;
                    //        case ("OUT OF SCOPE" && $xpdp[$tp][21] == "NO"):   // COUNTED AS OUT-OF-SCOPE
                    //        $sum1[$pc][2] = $sum1[$pc][2] + 1;
                    //        break;
                    //        case ("NOT SET" && $xpdp[$tp][21] == "NO"):        // COUNTED AS NOT-SET 
                    //        $sum1[$pc][3] = $sum1[$pc][3] + 1;
                    //        break;
					//}
        ...
        while($rowpae  = mysql_fetch_row($mysql_datapae)) {
              ...
              for ($pc=$paestart;$pc<=$paeend;++$pc) {
                   ...
                   if ($tp == 1){
                       ...
                       if ($pc == $paestart || $pc2 == 2  || $pc2 == 3 || $pc2 == 4 || $pc2 == 7  || $pc2 == 8  || $pc2 == 9  || $pc2 == 10  || $pc2 == 11  || $pc2 == 12 || $pc2 == 13 || $pc2 == 14 || $pc2 == 15 || $pc2 == 16  ){
