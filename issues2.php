...
$xreport_pth = "./reports/";
$xreport_nam = "ISSUE SUMMARY REPORT-".$ydate3.".htm";
//print ($reportname); 
//Start of HTML
//================================================================================================================
...
if ($start == 1) {
   ...
   $xreport_name = "ISSUE SUMMARY REPORT"; 
...
if ($found == 0) {
    ...
    print("<form method=\"post\" action=\"./issues2.php\">
   ...
   $query = "  select saved_report_id,report_name,filters,report_path,etl_id,report_timestamp,ran_by from ".$name.".saved_reports
                where rtrim(report_name) = 'ISSUE SUMMARY REPORT'
                  and ran_by = '$usr'
