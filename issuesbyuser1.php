...
print("<html>
        <head>
         ...
         textarea    { font-family: Calibri, Helvetica, sans-serif;
          ...
          caption    { background:#FFFFF0; color:#0000FF; font-size: 18x; font-weight: bold;}       
...
if ($start == 1) {
$captn = "Issues and Updates You have Raised";
print("   <table align=\"center\" style=\"border: 1px solid #CCCCCC; border-color:#CCCCCC; background-color: #FFFFFF;\">
             ...
             for ($l=1;$l<=$pimax[$p] ; ++$l) {
                  ...
                  if ($l <> $pimax[$p]) {
                    ...
                    if (($parityrot == 0 && $paritycnt == 0) && $parityind == 1) {
                         $paritychk = "ROOT CAUSE AND MISSED OPPORTUNITY MISSING";
                    }
                    if (($parityrot > 0 && $paritycnt == 0) && $parityind == 1) {
                         $paritychk = "MISSED OPPORTUNITY MISSING";
                         if ($parityrot > 1){
...
if ($start == 0) {       
    ...
    // ==============================
    $captn = "Select User";
    print(" <form method=\"post\" action=\"./issuesbyuser1.php\">
