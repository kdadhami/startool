   ...
   if ($rowcntx > 0) {
       ...
       while($rowx = mysql_fetch_row($mysql_datax)) {
             ...
             print("PDP ID             : ".$xid."<br>".
                   ...
                   "LAUNCH DATE        : ".$xpdp_launch."<br>".
                   "PDP STATUS         : ".$xpdp_status."<br>".
                   "PDP PERIOD ID      : ".$xpdp_period_id."<br>".
                   "PDP CATEGORY ID    : ".$xpdp_category_id."<br>".
                   "COMPLEXITY FACTOR  : ".$xcomplexity_id."<br>".
                   "PROJECTION FACTOR  : ".$xprojection_id."<br>".
                   "REVENUE FACTOR     : ".$xrevenue_id."<br>".
                   "PAST FACTOR        : ".$xpast_id."<br>".
                   "PDP PERIOD ID      : ".$xpdp_period_id."<br>".
                   "PDP MAIN ID        : ".$xmain_pdp_id."<br>".
                   "PDP PARENT ID      : ".$xparent_pdp_id."<br>".
                   "PDP NAME           : ".$xpdp_name."<br>".
                   "PDP OWNER          : ".$xpdp_owner."<br><br>");
             //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
             print("<br><br>====================================================================================<br><br>");
             ...
             print("MAIN PDP ID : ".$xmain_period_id."<br>".
                   "PDP         : ".$xmain_pdp_desc."<br><br>");
             // parent_pdp_id         
             ...
             print("PARENT PDP ID : ".$xparent_period_id."<br>".
                   "PDP           : ".$xparent_pdp_desc."<br><br>");
             // =========================================================================================
             // ================================== EXTRACT LAUNCH DATE ==================================
             // =========================================================================================
             ...
             print("<br>"."CATEGORY - ".$xpdp_category_id."-".$xcategory."<br>");
             $xfound = 0;
             for ($s=1;$s<=$scnt;++$s) {
             ...
             print("COMPLEXITY - ".$xpdp_complexity_id."-".$xcomplexity."<br>");
             $xfound = 0;            
             for ($s=1;$s<=$scnt ; ++$s) {
             ...
             print("PROJECTION - ".$xpdp_projection_id."-".$xprojection."<br>");
             $xfound = 0;             
             for ($s=1;$s<=$scnt ; ++$s) {
             ...
             print("REVENUE - ".$xpdp_revenue_id."-".$xrevenue."<br>");
             $xfound = 0;  
             for ($s=1;$s<=$scnt ; ++$s) {
                  if ($xpast_id == $sid[$s]){
                      $xpast        = $styp[$s];
             ...
             print("PAST - ".$xpdp_past_id.$xpast."<br>");
             $xfound = 0;  
             // =========================================================================================
             // ==================================== EXTRACT TRACKER ====================================
             // =========================================================================================
                          ...
                          for ($pit=1;$pit<=$pitcnt ; ++$pit) {
                               if ($ityp[$i] == $pityp[$pit]){
                                   ...
                                   if ($line == $pimax[$picnt]) {
                                       ...
                                       $tcnt0[$i] = $tcnt0[$i] + 1;
                                       for ($d=1;$d<=$dcnt;++$d) {
                                            print("<br>"."<br>"."<br>".$pidpt[$picnt]." - ".$dpt[$d]."<br>"."<br>"."<br>");                                       
                                            if (($pidpt[$picnt] == $dpt[$d]) && ($countdone_pi <> 1)){
                                                $dptix[$d] = $dptix[$d] + 1;
                                                $countdone_pi = 1;
                                                print("<br>"."<br>"."<br>"."I AM HERE"."<br>"."<br>"."<br>");
                                            } 
                                    ...
                                    if ($ityp[$i] == $putyp[$picnt][$put]){
                                        ...
                                        if ($line == $pimax[$picnt]) {
                                            ...
                                            for ($d=1;$d<=$dcnt;++$d) {
                                                 ...
                                                 print("<br>"."<br>"."<br>".$kda." - ".$dpt[$d]."<br>"."<br>"."<br>");
             ...
             if ($bypass == 0){
                 ...
                 for ($d=1;$d<=$dcnt;++$d) {
                      if ($dptix[$d] <> 0){                 
                          $query125 = "INSERT into ".$name.".cube1_d(etl_id,pdp,issue_area,issue_count)
                                       VALUES('$xetl_id','$xpdp_desc','$dpt[$d]','$dptix[$d]')";
                          print($query125."<br>");             
                          $mysql_data125 = mysql_query($query125, $mysql_link) or die ("#23.6 Could not query: ".mysql_error());
                      }
                 }
       ...
       //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
       for ($i=1;$i<=$icnt; ++$i) {
            $query304 = "INSERT into ".$name.".cube1_b_lov(etl_id,issue_type,issue_class,report_group,group_used)
                         VALUES('$xetl_id','$ityp[$i]','$iccd[$i]','$irgrp[$i]','$igrp[$i]')";
            print($query304."<br>");             
            $mysql_data304 = mysql_query($query304, $mysql_link) or die ("#23.1 Could not query: ".mysql_error());
       }
       for ($d=1;$d<=$dcnt;++$d) {
            $query305 = "INSERT into ".$name.".cube1_c_lov(etl_id,issue_area)
                         VALUES('$xetl_id','$dpt[$d]')";
            print($query305."<br>");             
            $mysql_data305 = mysql_query($query305, $mysql_link) or die ("#23.6 Could not query: ".mysql_error());
       }
