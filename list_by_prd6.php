...
// -------------------------------------
    ...
    $queryx = "select a.pdp_id,a.pdp_desc,a.updated_date,a.updated_by,a.pdp_name,a.pdp_owner,a.pdp_launch,
                     ...
                     a.revenue_id,a.comparison_id,a.pdp_period_id,b.pdp_period 
   ...
   // $rowcntx is no. of pdps found in a pdp type
   $seq1 = 0;
   $seq  = 0;
   if ($rowcntx > 0) {
       $found = 1;
       ...
       print("
                      ...
                      <td bgcolor=\"#99CCFF\" align=\"left\" valign=\"middle\" style=\"word-wrap: break-word; word-break:break-all; width:75px;\">
                       <font color=\"#330099\">
                        Customer Impact
                       </font>
                      </td>
       ...
       print("
            <tr>
             <td bgcolor=\"#CCFFFF\" valign=\"middle\" align=\"center\" style=\"word-wrap: break-word; word-break:break-all; width:75px;\">
	          <font color=\"#330099\"> 
               $xpdp_desc
              </font> 
             </td>
             <td bgcolor=\"#CCFFFF\" style=\"word-wrap: break-word; word-break:break-all; width:200px;\">
              <font color=\"#330099\">                
               <p>$xpdp_name</p>
              </font>
             </td>
	         <td valign=\"middle\" bgcolor=\"#CCFFFF\" align=\"center\" style=\"word-wrap: break-word; word-break:break-all; width:75px;\">
	           <font color=\"#330099\"> 
                $xpdp_owner
               </font> 	            
	          </td>
             ...
             <td bgcolor=\"#CCFFFF\" align=\"center\" style=\"word-wrap: break-word; word-break:break-all; width:75px;\">                
              <font color=\"#330099\">
               $xpdp_launch_dt
              </font>
             </td>
      ...
      if ($rowcnty2 > 0) {
          while($rowy2 = mysql_fetch_row($mysql_datay2)) {
                ...
                while($rowx3 = mysql_fetch_row($mysql_datax3)) {
                     ...
                     print("
                             <td valign=\"middle\" bgcolor=\"#CCFFFF\" align=\"center\" width=\"75px\">
                              <font color=\"#330099\">
                     ");
                     for ($e=1;$e<=2; ++$e) {
     ...
     print("        
       ...
       //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
           ...
           {
             print("
                   <td bgcolor=\"#CCFFF\" align=\"center\" style=\"word-wrap: break-word; word-break:break-all; width:75px;\">
                    <font color=\"#330099\">
                     $rowcnt
                    </font>
                   </td>
   ...
   } else
   {
       ...
       echo "<script type=\"text/javascript\">window.alert(\"No PDP for this Period was not found, Try Again\")</script>";  
          ...
          print("
                     <tr>
                      <td bgcolor=\"#E8E8E8\" colspan=\"17\" align=\"center\" valign=\"middle\">
                       <font color=\"#330099\">
                       </font>
                      </td>
...
if ($found == 0) {
   ...
   print("<form method=\"post\" action=\"./list_by_prd6.php\">
