...
//============================================================================
        ...
        //print("<br>");
		// Reindex done
        print("<br><br><br>START OF RETROFIT RUN FOR ARCHIVE<br><br>");
		
            $query9 = "select execution_id,
			                  milestone_id,
					          iteration_count,
							  milestone_surrogate_archive_id 
			...
			print("<br>".$query9."<br>");
            print("<br>Rows Found.............: ".$rowcnt9."<br><br>");			
            ...
            if ($rowcnt9 <> 0){
                while($rowx9 = mysql_fetch_row($mysql_data9)) {
					  ...
					  $ymilestone_sur_archive_id  = stripslashes($rowx9[3]);
                      print("No......................: ".$e."<br>");
                      ...
                      $query11 = "UPDATE ".$name.".milestone_surrogates_archive
                                     SET baseline_time         = '$ymil_base_time',
                                         incremental_time      = '$ymil_incr_time',
                                         total_time            = '$ymil_totl_time',
                                         retrofit_parity       = '$ymil_parity',
								         occurance             = 1
                                   WHERE milestone_surrogate_archive_id = '$ymilestone_sur_archive_id' ";
					  //}
                      ...
                      //$query35 = "INSERT into ".$name.".milestone_surrogates_archive
					  //                                                      (
					  //                                                       execution_id,
					  //                                                       milestone_id,
					 // 														 iteration_count,
